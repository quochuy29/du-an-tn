@section('title', 'Tạo loại giảm giá')
            ...
            <div class="card-header">
                <ol class="breadcrumb float-sm-left ">
                    <li class="breadcrumb-item"><a class="card-title" href="{{route('couponType.index')}}">Danh sách
                            loại giảm giá</a></li>
                    <li class="breadcrumb-item active">Tạo loại giảm giá</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mt-2"><br>
                            <div class="float-left">
                                ...
                                <a href="{{route('couponType.index')}}" class="btn btn-danger">Hủy</a>
                            </div>
                        </div>
                    </div>
                </div>
